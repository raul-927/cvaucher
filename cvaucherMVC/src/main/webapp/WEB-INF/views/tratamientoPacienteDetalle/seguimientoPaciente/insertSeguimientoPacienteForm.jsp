	...
	<sf:form cssClass ="form" action="?seg"
		modelAttribute ="seguimientoPacientes">
	        ...
	        <div class="form-group">
		 	...
		 	<div class="form-group">
			 	<sf:label path="brazoI" for ="brazoI">Brazo Izquierdo</sf:label>
		 	...
		 	<div class="form-group">
			 	<sf:label path="brazoD" for ="brazoD">Brazo Derecho</sf:label>
		 	...
		 	<div class="form-group">
			 	<sf:label path="muzloI" for ="muzloI">Muzlo Izquierdo</sf:label>
		 	...
		 	<div class="form-group">
			 	<sf:label path="muzloD" for ="muzloD">Muzlo Derecho</sf:label>
		 	...
		 	<div class="form-group">
			 	<sf:label path="abdomen" for ="abdomen">Abdomen</sf:label>
		 	...
		 	<div class="form-group">
			 	<sf:label path="cintura" for ="cintura">Cintura</sf:label>
		 	...
		 	<div class="form-group">
			 	<sf:label path="cadera" for ="cadera">Cadera</sf:label>
		 	...
		 	<div class="form-group">
			 	<sf:label path="peso" for ="peso">Peso</sf:label>
