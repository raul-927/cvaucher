...
public class PagoEfectivo implements Serializable
{
	...
	public int getPagoEfAsientoNro() {
		return pagoEfAsientoNro;
	}
	public void setPagoEfAsientoNro(int pagoEfAsientoNro) {
		this.pagoEfAsientoNro = pagoEfAsientoNro;
	}
