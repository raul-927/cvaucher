...
-- Volcando datos para la tabla est_vaucher.cuentas: ~14 rows (aproximadamente)
/*!40000 ALTER TABLE `cuentas` DISABLE KEYS */;
REPLACE INTO `cuentas` (`cuenta_id`, `cuenta_grupo_id`, `cuenta_desc`, `cuenta_fecha`, `cuenta_hora`, `cuenta_usuario`) VALUES
	(1, 8, 'EFECTIVO_CAJA', '2016-05-16', '23:19:00', 'admin'),
	(2, 9, 'OCA', '2016-05-16', '23:19:01', 'admin'),
	(3, 9, 'VISA', '2016-05-16', '23:20:00', 'admin'),
	(4, 9, 'MASTER', '2016-05-16', '23:20:00', 'admin'),
	(5, 9, 'DINERS', '2016-05-16', '23:20:00', 'admin'),
	(6, 9, 'AMERICAN_EXPRESS', '2016-05-22', '11:59:00', 'gaby'),
	(7, 7, 'BCP', '2016-05-16', '23:20:00', 'admin'),
	(8, 7, 'BROU', '2016-05-16', '23:21:00', 'admin'),
	(9, 11, 'IVA 22%', '2016-05-16', '23:45:00', 'admin'),
	(10, 11, 'IGV', '2016-05-16', '23:46:00', 'admin'),
	(11, 12, 'OCA 10%', '2016-05-16', '23:46:00', 'admin'),
	(12, 15, 'MASAJES', '2016-05-23', '21:19:00', 'admin'),
	(13, 15, 'LIMPIEZA', '2016-05-23', '21:19:00', 'admin'),
	(14, 9, 'ANDA', '2016-05-31', '10:50:00', 'admin');
...
-- Volcando datos para la tabla est_vaucher.historial_pagos: ~4 rows (aproximadamente)
...
REPLACE INTO `historial_pagos` (`hist_pagos_id`, `hist_pagos_trat_pac_id`, `hist_tipo_pago`, `hist_pagos_fecha_pago`, `hist_pagos_hora_pago`, `hist_pagos_monto`, `hist_pagos_usuario`) VALUES
	(627, 511, 'OCA', '2016-05-31', NULL, 850, NULL),
	(628, 512, 'EFECTIVO', '2016-05-31', NULL, 4500, NULL),
	(638, 522, 'EFECTIVO', '2016-05-31', NULL, 850, NULL),
	(641, 525, 'EFECTIVO', '2016-05-31', NULL, 3000, NULL);
...
-- Volcando datos para la tabla est_vaucher.pago_efectivo: ~3 rows (aproximadamente)
...
REPLACE INTO `pago_efectivo` (`ef_id`, `pago_ef_id`, `pago_ef_cedula`, `pago_ef_importe`, `pago_ef_desc`, `pago_ef_usuario`) VALUES
	(344, 512, 44188684, 4500, 'EFECTIVO', NULL),
	(354, 522, 44188684, 850, 'EFECTIVO', NULL),
	(357, 525, 44188684, 3000, 'EFECTIVO', NULL);
...
-- Volcando datos para la tabla est_vaucher.pago_tarjetas: ~1 rows (aproximadamente)
...
REPLACE INTO `pago_tarjetas` (`tarj_id`, `tarj_pac_cedula`, `tarj_pago_id`, `tarj_nro`, `tarj_desc`, `tarj_vence`, `tarj_importe`, `tarj_cuotas`, `tarj_pago_usuario`) VALUES
	(107, 44188684, 511, 1234567894514141, 'OCA', '2018-05-28', 850, 10, NULL);
...
-- Volcando datos para la tabla est_vaucher.tratamiento: ~53 rows (aproximadamente)
...
) ENGINE=InnoDB AUTO_INCREMENT=526 DEFAULT CHARSET=latin1 COMMENT='private int tratPacId;\r\nprivate Date fecha;\r\nprivate Pacientes pacientes;\r\nprivate Tratamiento tratamiento;\r\nprivate int cantSesiones;\r\nprivate int sesionesRealizadas;\r\nprivate int sesionesPendientes;\r\nprivate int costoTratamiento;\r\nprivate int importePagado;\r\nprivate int saldoPendiente;';

-- Volcando datos para la tabla est_vaucher.tratamiento_paciente: ~4 rows (aproximadamente)
...
REPLACE INTO `tratamiento_paciente` (`trat_pac_id`, `pac_cedula`, `trat_id`, `fecha`, `costo_tratamiento`, `importe_pagado`, `saldo_pendiente`, `cant_sesiones`) VALUES
	(511, 44188684, 2, '2016-05-31', 850, 850, 0, 1),
	(512, 44188684, 19, '2016-05-31', 4500, 4500, 0, 8),
	(522, 44188684, 2, '2016-05-31', 850, 850, 0, 1),
	(525, 44188684, 30, '2016-05-31', 3000, 3000, 0, 10);
