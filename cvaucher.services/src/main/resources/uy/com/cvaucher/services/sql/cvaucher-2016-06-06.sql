...
-- Volcando datos para la tabla est_vaucher.asiento_contable: ~4 rows (aproximadamente)
...
REPLACE INTO `asiento_contable` (`as_con_id`, `as_con_nro`, `as_cuenta_debe`, `as_cuenta_debeMonto`, `as_cuenta_haber`, `as_cuenta_haberMonto`, `as_con_descripcion`, `as_con_fecha`, `as_con_hora`, `as_con_usr`) VALUES
	(7, 2, 1, 0, 1, 850, 'Ultracavitacion', '2016-06-03', '21:05:49', NULL),
	(8, 2, 30, 850, 30, 0, '0', NULL, NULL, NULL),
	(9, 1, 2, 0, 2, 150, '0', NULL, NULL, NULL),
	(10, 1, 1, 150, 1, 0, '0', '2016-06-04', NULL, NULL);
...
REPLACE INTO `cuentas` (`cuenta_id`, `cuenta_form_pago_id`, `cuenta_grupo_id`, `cuenta_desc`, `cuenta_fecha`, `cuenta_hora`, `cuenta_usuario`) VALUES
	(1, 0, 8, 'EFECTIVO_CAJA', '2016-05-16', '23:19:00', 'admin'),
	(2, 0, 9, 'OCA', '2016-05-16', '23:19:01', 'admin'),
	(3, 0, 9, 'VISA', '2016-05-16', '23:20:00', 'admin'),
	(4, 0, 9, 'MASTER', '2016-05-16', '23:20:00', 'admin'),
	(5, 0, 9, 'DINERS', '2016-05-16', '23:20:00', 'admin'),
	(6, 0, 9, 'AMERICAN_EXPRESS', '2016-05-22', '11:59:00', 'gaby'),
	(7, 0, 7, 'BCP', '2016-05-16', '23:20:00', 'admin'),
	(8, 0, 7, 'BROU', '2016-05-16', '23:21:00', 'admin'),
	...
	(14, 0, 9, 'ANDA', '2016-05-31', '10:50:00', 'admin');
...
-- Volcando datos para la tabla est_vaucher.historial_pagos: ~1 rows (aproximadamente)
...
CREATE TABLE IF NOT EXISTS `impuesto` (
  ...
  `impuesto_valor` decimal(10,0) NOT NULL DEFAULT '0',
  PRIMARY KEY (`impuesto_id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1;

-- Volcando datos para la tabla est_vaucher.impuesto: ~2 rows (aproximadamente)
/*!40000 ALTER TABLE `impuesto` DISABLE KEYS */;
REPLACE INTO `impuesto` (`impuesto_id`, `impuesto_desc`, `impuesto_desc_abrv`, `impuesto_valor`) VALUES
	(1, 'Impuesto al Valor Agregado', 'IVA', 22),
	(2, 'Sin Impuestos', 'S/IMP', 0);
...
-- Volcando datos para la tabla est_vaucher.lista_precios: ~106 rows (aproximadamente)
...
-- Volcando datos para la tabla est_vaucher.pago_efectivo: ~1 rows (aproximadamente)
...
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `SP_resumenPorCuentasTotal`()
BEGIN
...
CREATE TABLE IF NOT EXISTS `tipo_tratamiento` (
  ...
  KEY `FK_tipo_tratamiento_impuesto` (`impuesto_id`),
  CONSTRAINT `FK_tipo_tratamiento_impuesto` FOREIGN KEY (`impuesto_id`) REFERENCES `impuesto` (`impuesto_id`)
...
REPLACE INTO `tipo_tratamiento` (`tip_trat_id`, `tip_trat_descripcion`, `impuesto_id`) VALUES
	(1, 'Relax', NULL),
	(2, 'Terapeutico', NULL),
	(3, 'Modelador', NULL),
	(4, 'Estetico', NULL),
...
) ENGINE=InnoDB AUTO_INCREMENT=531 DEFAULT CHARSET=latin1 COMMENT='private int tratPacId;\r\nprivate Date fecha;\r\nprivate Pacientes pacientes;\r\nprivate Tratamiento tratamiento;\r\nprivate int cantSesiones;\r\nprivate int sesionesRealizadas;\r\nprivate int sesionesPendientes;\r\nprivate int costoTratamiento;\r\nprivate int importePagado;\r\nprivate int saldoPendiente;';

-- Volcando datos para la tabla est_vaucher.tratamiento_paciente: ~1 rows (aproximadamente)
